...
const AffiliateSettingsPage = () => {
  ...
  useEffect(() => {
    ...
    // Check if we're in portal or dashboard view based on the URL
    const pathname = window.location.pathname;
    setIsPortalView(!pathname.includes('/dashboard'));
  }, [navigate]);
    ...
    <AffiliatePortalLayout>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white shadow overflow-hidden sm:rounded-lg">
            <div className="px-4 py-5 sm:px-6 border-b border-gray-200">
              <h3 className="text-lg leading-6 font-medium text-gray-900">Language and Region</h3>
              <p className="mt-1 max-w-2xl text-sm text-gray-500">Customize your language settings and regional preferences.</p>
            </div>
            <div className="px-4 py-5 sm:p-6">
              <div className="grid grid-cols-1 gap-y-6 sm:grid-cols-6 sm:gap-x-6">
                <div className="sm:col-span-3">
                ...
                <div className="sm:col-span-6">
                  <p className="text-sm text-gray-500">
                    These settings will determine which marketing materials are available for you to download and use in your promotions.
                  </p>
                </div>
              </div>
            </div>
